...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Google/input__q'), 0)
...
WebUI.click(findTestObject('Object Repository/Page_katalon - Tm trn Google/svg'))
